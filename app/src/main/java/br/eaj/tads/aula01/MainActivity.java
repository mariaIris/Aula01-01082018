...
public class MainActivity extends AppCompatActivity {
  ...
  @Override
    protected void onCreate(Bundle savedInstanceState) {//um dos primeiros metodos do ciclo de vida do android
        super.onCreate(savedInstanceState);//
        setContentView(R.layout.activity_main);//minha tela vai ter a view desenhada, essa tela é obrigatória

        texto = findViewById(R.id.ola); //instancia
        ...
        btLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("batatinha","O texto foi:"+ texto_edit);
            }
        });
   ...
   /* public void bananinha_clique(View v){
        ...
        TextView texto = findViewById(R.id.ola);
        texto.setText(texto_edit);
    */
}
